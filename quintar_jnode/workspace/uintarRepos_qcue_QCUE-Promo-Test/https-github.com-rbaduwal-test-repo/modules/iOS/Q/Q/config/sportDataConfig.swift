...
public class sportDataConfig: config {
   ...
   public struct decodableData: Decodable {
      ...
      public let apiEntrypointUrl: String
      
      // Optional for parsing
      public let liveDataUrl: String? // This is required if live, but not for parsing purposes
      public var retryConnectionInterval: Float? = defaults.liveDataTimeout
      public var apiCallFrequency: Float?
      public var playerColors: [String]? = defaults.playerColors
