...
extension UIViewController {
   func setUpNavigationBar(title: String) {
      let playerImage = UIBarButtonItem(image: UIImage (named: "logo_on_white")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal), style: UIBarButtonItem.Style.plain, target: self, action: nil)
